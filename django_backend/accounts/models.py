...
class TraineeProfile(models.Model):
    ...
    def save(self, *args, **kwargs):
        # Determine if this is a new image upload or if we need to convert
        ...
        if self.profile_image:
            ...
            try:
                ...
                return # PIL not installed, skip optimization
            ...
            if os.path.exists(img_path) and not img_path.lower().endswith('.webp'):
                try:
                    ...
                    # Update field
                    self.profile_image.name = os.path.splitext(self.profile_image.name)[0] + '.webp'
                    
                    # Remove original file if they are different
